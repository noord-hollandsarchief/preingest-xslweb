...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
    HTTP requests will look like transform/topx2xip/0ee4629b-3394-6986-b859-430c0256ecd1/path/to/name.metadata and
    transform/prewash/0ee4629b-3394-6986-b859-430c0256ecd1/path/to/name.metadata?prewash=prewash-stylesheet, for which
    "/*/req:path" does not include any query parameters.
  -->
