    ...
    <pipeline:pipeline>
      ...
      <pipeline:schema-validator name="schema-validator" xsl-param-name="schema-validation-report">
        <pipeline:schema-paths>
          <pipeline:schema-path>MDTO-XML1.0.xsd</pipeline:schema-path>
        </pipeline:schema-paths>
      </pipeline:schema-validator>
	  
	  <!-- Then validate using Schematron: -->
      <pipeline:schematron-validator name="schematron-validator" schematron-path="mdto.sch" xsl-param-name="schematron-validation-report"/>
